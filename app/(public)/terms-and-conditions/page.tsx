 ...
 const terms = [
    {
      ...
      text: "ইনসান বিডি প্ল্যাটফর্ম ব্যবহারের মাধ্যমে আপনি আমাদের সকল আইনি শর্তাবলী মেনে নিচ্ছেন বলে গণ্য হবে। আমাদের লক্ষ্য স্বচ্ছতা বজায় রাখা, তাই ব্যবহারের আগে এই নিয়মগুলো গুরুত্বসহকারে পড়ুন।"
    },
    {
      id: "donations",
      icon: <CreditCard />,
      ...
      text: "প্রদানকৃত সকল অনুদান সরাসরি এতিম শিশুদের কল্যাণে ব্যয় করা হয়। অনুদান দেওয়ার সময় সঠিক তথ্য প্রদান করা দাতার দায়িত্ব। প্রযুক্তিগত ত্রুটির বাইরে সাধারণ অবস্থায় অনুদান ফেরতযোগ্য নয়।"
    },
    {
      id: "registration",
      icon: <UserCheck />,
      color: "bg-[#2A9D8F]",
      title: "ব্যবহারকারীর দায়বদ্ধতা",
      text: "স্বেচ্ছাসেবী বা দাতা হিসেবে নিবন্ধনের সময় আপনার সঠিক তথ্য প্রদান বাধ্যতামূলক। আপনার অ্যাকাউন্টের মাধ্যমে সংঘটিত সকল কার্যক্রমের দায়ভার আপনার। কোনো অনৈতিক কাজে প্ল্যাটফর্ম ব্যবহার করা যাবে না।"
    },
    {
      id: "intellectual",
      icon: <Globe />,
      ...
      text: "এই ওয়েবসাইটের সকল কন্টেন্ট, লোগো এবং শিশুদের ছবি ইনসান বিডি-র সম্পদ। অনুমতি ব্যতীত কোনো ছবি বা তথ্য বাণিজ্যিক বা ব্যক্তিগত প্রয়োজনে কপি বা প্রচার করা আইনত দণ্ডনীয়।"
    },
    {
      id: "conduct",
      icon: <Ban />,
      ...
      text: "সিস্টেম হ্যাকিং, অটোমেটেড বট ব্যবহার, বা অন্য কোনো ব্যবহারকারীর গোপনীয়তা নষ্ট করার চেষ্টা করলে তাৎক্ষণিক আইনি ব্যবস্থা গ্রহণ করা হবে এবং অ্যাকাউন্ট স্থায়ীভাবে নিষিদ্ধ করা হবে।"
    }
  ];
