...
export default function Hero() {
  ...
  const [isLoggedIn, setIsLoggedIn] = useState(false); // লগইন স্টেট
  ...
  <div className="relative w-full h-full aspect-square max-w-[500px] mx-auto flex items-center justify-center">
    ...
    <div className="absolute inset-0 flex items-center justify-center">
      ...
      <div className="relative">
        <div className="p-8 bg-white/40 backdrop-blur-3xl rounded-full border border-white/50 shadow-2xl">
          <Users size={50} className="text-[#2A9D8F] opacity-40" strokeWidth={1.5} />
        </div>
        ...
        {[...Array(3)].map((_, i) => (
          <motion.div
            ...
            style={{ width: 120 + i * 40, height: 120 + i * 40, marginLeft: -(60 + i * 20), marginTop: -(60 + i * 20) }}
          >
    ...
    >
      ...
      <div className="flex justify-between items-center pt-3 border-t border-gray-50">
         <span className="text-[10px] font-bold text-[#2A9D8F] tracking-tighter">— মুসনাদে আহমাদ</span>
    ...
    >
      ...
      <div className="relative z-10">
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className="text-[10px] font-bold text-white/40 uppercase tracking-widest">Live Transparency</span>
        </div>
        <div className="space-y-1">
          <p className="text-2xl md:text-3xl font-black text-white tracking-tighter">১০০%</p>
          <p className="text-xs font-bold text-[#2A9D8F]">সরাসরি সহযোগিতা</p>
        </div>
